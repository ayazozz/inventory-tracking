    ...
    public partial class Urunler : Form
    {
        ...
        public void DataGridDoldur()
        {
            try
            {
                ...
                DGW.Columns[9].HeaderText = "Ürünün Lokasyonu";
        ...
        private void PbKaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                komut = new OleDbCommand("INSERT INTO Urunler(UrunAd,KategoriAd,UrunAciklama,UrunAdet,UrunBirim,UrunFiyat,UrunEklemeTarih,UrunLokasyonu) VALUES('" + TxtAd.Text + "','" + CbKategori.Text + "','" + TxtAciklama.Text + "','" + TxtAdet.Text + "','" + TxtBirim.Text + "','" + TxtFiyat.Text + "','" + TxtEklemeTarihi.Value.ToShortDateString() + "','" +txtUrunLokasyonu.Text +"')", baglanti);
