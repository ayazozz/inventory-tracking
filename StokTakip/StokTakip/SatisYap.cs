    ...
    public partial class SatisYap : Form
    {
        ...
        public void DataGridDoldur()
        {
            try
            {
                ...
                DGW.Columns[9].HeaderText = "Ürün Lokasyonu";
        ...
        private void PbSatisYap_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                komut = new OleDbCommand();
                baglanti.Open();     
                komut = new OleDbCommand("INSERT INTO SatisTakip(UrunAd,KategoriAd,UrunAciklama,UrunAdet,UrunBirim,UrunFiyat,UrunSatisTarih,UrunNo,SatısSorumlusu,NakliyatLokasyonu) VALUES('" + TxtAd.Text + "','" + CbKategori.Text + "','" + TxtAciklama.Text + "','" + TxtAdet.Text + "','" + TxtBirim.Text + "','" + TxtFiyat.Text + "','" + TxtEklemeTarihi.Value.ToShortDateString() + "','" + sirano + "','" + kullanıcıadi+ "','" + txtNakliyatLokasyonu.Text + "')", baglanti);
                komut.ExecuteNonQuery();
                baglanti.Close();
